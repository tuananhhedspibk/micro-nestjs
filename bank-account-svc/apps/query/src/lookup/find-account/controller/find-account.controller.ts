...
import { BANK_ACCOUNT_QUERY_SERVICE_NAME } from '@command/common/proto/bank-account-query.pb';

import { FindAccountDto } from './find-account.dto';

import { FindAccountQuery } from '../query/find-account.query';
import { FindAccountResponse } from '@query/common/proto/bank-account-query.pb';
...
export class FindAccountController {
  ...
  private async findAccount(
    @Payload() payload: FindAccountDto,
